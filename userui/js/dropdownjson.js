$(function () {
    ...
    //         prin += ` <a class="c-dropdown__item dropdown-item form-check form-check-inline hello" href="#" style="padding:4px 0 0 5px;">
    ...
    //     }
    //     $('.droppingtracking').append(prin);
    //     $('.inditracking').append(prin);
